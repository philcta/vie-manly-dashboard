...
const QUESTION_CATEGORIES: QuestionCategory[] = [
    {
        ...
        questions: [
            "What's my labour cost % this week vs the 24% target? Am I on track?",
            ...
            "What are my revenue-per-hour figures for each day? Which day needs fewer staff?",
            "How does this week's labour efficiency compare to the last 4 weeks? Am I improving?",
            "What's my labour cost gap to hit the 24% target? How many hours do I need to cut?",
        ],
    },
    {
        id: "margins",
        ...
        questions: [
            ...
            "Which categories delivered the highest gross profit this week in dollars?",
            "What would happen to monthly profit if I lifted average sale by $1?",
            "How are we doing this month? Show me MTD sales vs item count",
            "Rank my bottom 5 margin categories — should I drop or reprice any?",
            "Which high-margin categories above 50% should I promote more?",
            "Show me the Cafe vs Retail margin split — which side is more profitable?",
            "What's trending: compare this week vs last week for the top 5 categories in a table",
            "How much revenue am I losing from discounts this week? Net vs Gross breakdown",
            "Are my average sale and real profit targets on track? Show me the KPI status",
        ],
    },
    {
        id: "members",
        ...
        questions: [
            "Who are my top 10 highest-spending members this month? Are any slowing down?",
            "What % of my revenue comes from members vs walk-ins? Is the member goal improving?",
            "What's the avg spend difference between members and non-members this week?",
            "How many new members signed up this week vs last? Which day gets the most sign-ups?",
            "What's my points redemption rate? Are members actually using their loyalty points?",
            "How many members are showing 'cooling' or 'at-risk' patterns? What should I do?",
            "Write me a re-engagement SMS for members who haven't visited in 2+ weeks",
            "If I can re-activate 10 cooling members, what's the revenue impact based on their avg spend?",
            "What loyalty campaign would work best this week based on current member engagement data?",
            "Compare member visit frequency this week vs last month — is engagement growing?",
        ],
    },
    {
        id: "stock",
        ...
        questions: [
            "How many dead stock items do I have? What's the total capital tied up?",
            "Which items are running out soon? Show me stockout risks for the next 2 weeks",
            "What should I reorder this week? Group by vendor so I can place combined orders",
            "Show me out-of-stock items that were selling well — how much revenue am I losing?",
            "Which products are trending UP in velocity this week? I want to push them",
            "Which products are trending DOWN? Should I discount or reduce orders?",
            "How much waste did we have this month? Which items are spoiling the most?",
            "Find me high-margin products over 45% that are underselling — I'll promote these today",
            "Show me all overstock items above 90 days of stock — time for a clearance plan",
            "What categories have the most stock alerts? Give me a priority action list",
            "How is our dead/overstock target going? We need to reduce by 30% — where are we?",
            "Look up kombucha products — how are they performing and what needs restocking?",
        ],
    },
    {
        id: "gameplan",
        ...
        questions: [
            "Give me my Monday morning briefing — how did last week go across all metrics?",
            "Score my week: rate labour, margins, members, and stock out of 10",
            "Where do I stand on all 5 KPI targets? Which ones need urgent attention?",
            "What are the 3 biggest things holding back profitability right now?",
            "Show me daily sales breakdown for this week — which days underperformed?",
            "Build me a promotional plan: 3 high-margin products to push, with expected profit impact",
            "What does a good week look like for VIE? Define it in exact numbers from the KPI goals",
            "If I get 5 more members per week and lift avg sale by $2, what's the annual impact?",
            "Summarise my inventory health: stock alerts, waste, dead stock, and vendor reorder needs",
            "Give me one quick win I can do TODAY to improve profitability based on current data",
            "What's our month-to-date performance? Are we on pace for a strong March?",
        ],
    },
];
